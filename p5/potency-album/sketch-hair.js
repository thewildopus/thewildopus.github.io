...
function preload() {
      // egg = loadImage('../../images/face3b.png')
      // egg2 = loadImage('../../images/face3.png')
      // bigface = loadImage('../../images/bigface.png')
        egg = loadAnimation("lady.png", "lady2.png", "lady3.png", "lady4.png", "lady5.png","lady4.png", "lady3.png", "lady2.png");
...
function setup() {
  ...
  // soundFile = createAudio('../../assets/zoremetdadavideo.mp3')
...
// alpha Number: (Optional)
  ...
  for (i=150; i<1800; i+=195){

  for (y=150; y<1000; y+=300){
        animation(egg, i, y);
...
Particle.prototype.update = function(someLevel) {
  ...
  this.diameter = map(someLevel, 0, 200, 0, 40) * this.scale * theyExpand;
  this.diameterSmall = map(someLevel, 0, 200, 30, 10) * this.scale * theyExpand;
...
// ellipse(this.position.x, this.position.y, this.diameter, this.diameter);
            ...
            // image(egg, this.position.x-this.diameter/2, this.position.y-this.diameter/2, this.diameter, this.diameter);
              // animation(egg, this.diameter, this.diameter);
    }
